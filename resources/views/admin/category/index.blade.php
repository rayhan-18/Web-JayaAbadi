...
<style>
    ...
    .table-wrapper {
        ...
        box-shadow: var(--shadow-card); width: 100%; overflow-x: auto; padding-bottom: 4px;
    }
    table { width: 100%; border-collapse: collapse; font-size: 13.5px; min-width: 800px; }
    th { text-align: left; padding: 16px 24px; background: rgba(0,0,0,0.015); font-weight: 600; color: var(--text-sec); border-bottom: 1px solid var(--border); text-transform: uppercase; font-size: 12px; }
    td { padding: 16px 24px; border-bottom: 1px solid var(--border); color: var(--text-main); font-weight: 500; }
    ...
    .action-btn {
        ...
        background: var(--bg-surface); border: 1px solid #e2e8f0; color: var(--text-sec); text-decoration: none; font-size: 16px; cursor: pointer;
    }
    .action-btn:hover { background: var(--bg-hover); color: var(--accent); }

    .pagination { display: flex; justify-content: space-between; align-items: center; margin-top: 24px; font-size: 13.5px; color: var(--text-sec); }
    .pagination-links a, .pagination-links span { padding: 8px 14px; border: 1px solid var(--border); border-radius: 8px; margin: 0 2px; }
