...
<style>
    ...
    /* ── Two Column Layout ── */
    /* Tambahkan min-width: 0 agar grid tidak melar keluar layar */
    ...
    /* Tambahkan min-width: 0 dan width: 100% agar card tidak ikut melebar jika isi tabel kebesaran */
    .card { 
    ...
    /* ── Table Design (Horizontal Scroll Fixed) ── */
    .table-wrapper { 
        width: 100%;
        display: block;
        overflow-x: auto; 
...
<div class="two-col">
    <div class="left-col">
        ...
        {{-- Tabel Pesanan Terbaru (Dengan Horizontal Scroll Penuh) --}}
        <div class="card">
            <div class="card-header">
            ...
            <div class="table-wrapper">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <a href="{{ route('admin.order.index') }}" class="invoice-link">#{{ $order->order_number }}</a>
                            </td>
                            <td>
